...
#         used_dynamic_field_key_list = self.data_object.get_used_dynamic_field_keys()
#         # Get node name hierarchy.
#         eventoccurrence_node_nameelf.resources_object.get_event_node_names()
#         # Get all node info.
...
#                 event_control_dict[event_node_name]['dwc_event_key_name'] = event_nodes[event_node_name].get('dwc_event_key_name', '')
...
#                 occurrence_dwc_event_key_name = dwc_keys_row.get('dwc_event_key_name', '')
...
#                     dwc_event_key_name = target_row.get(occurrence_dwc_event_key_name, '')
#                     emof_param_unit_id = target_row.get('emof_param_unit_id', '')
#                     
#                     occurrence_key = dwc_key
#                     if dwc_key == dwc_event_key_name:
#                         occurrence_key = ''
#          
...
#                         if parameter:
#                             measurementorfact_dict = {}
#                             measurementorfact_dict['id'] = dwc_event_key_name
#                             measurementorfact_dict['eventID'] = dwc_event_key_name
