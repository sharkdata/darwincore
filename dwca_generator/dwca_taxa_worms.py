                ...
                for index, row in enumerate(translate_file):
                    ...
                    if index == 0:
                        ...
                        if len(row) >= 2:
                            ...
                            info_dict["worms_scientific_name"] = row_dict.get("scientific_name", "")
                            ...
                            info_dict["worms_valid_aphia_id"] = row_dict.get("valid_aphia_id", "")
                            info_dict["worms_valid_name"] = row_dict.get("valid_name", "")
                            info_dict["worms_valid_authority"] = row_dict.get("valid_authority", "")
