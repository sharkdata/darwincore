...
def post_to_yamr_prod(yame_id_list):
    ...
    response = requests.post(url='https://sid-metadata.smhi.se/yamr/apipri/publish', json = {'uuids': yame_id_list}, headers=headers)
    print(response.text)
...
if __name__ == "__main__":
    ...
    with open(Path(__file__).parent / "dwca_config/metadata_templates/fileID_datatype_match.json", encoding='utf-8') as f:
